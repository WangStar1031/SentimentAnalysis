...
function updateCellValue(editableGrid, rowIndex, columnIndex, oldValue, newValue, row, onResponse)
{
    ...
    $.ajax({
        url: '../ajax/data_stopwords.php?action=update',
        type: 'POST',
        dataType: "html",
        data: {
...
{
    this.editableGrid = new EditableGrid("stopwords", {
        enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
    ...
    this.editableGrid.loadJSON("../ajax/data_stopwords.php?action=load");
...
DatabaseGrid.prototype.deleteRow = function(id)
{
   ...
   var self = this;
    ...
    if ( confirm('Are you sur you want to delete the Keyword  ' + id )  )
    {
        ...
        $.ajax({
            url: '../ajax/data_stopwords.php?action=delete',
            type: 'POST',
            dataType: "html",
            data: {
                id: id
...
DatabaseGrid.prototype.addRow = function(id)
{
    ...
    $.ajax({
        url: '../ajax/data_stopwords.php?action=insert',
        type: 'POST',
        dataType: "html",
        data: {
