...
function updateCellValue(editableGrid, rowIndex, columnIndex, oldValue, newValue, row, onResponse)
{
    ...
    $.ajax({
        url: '../ajax/data_profile.php?action=update',
        type: 'POST',
        dataType: "html",
        data: {
...
{
    this.editableGrid = new EditableGrid("analisitweets", {
        enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
    ...
    this.editableGrid.loadJSON("../ajax/data_profile.php?action=load");
...
DatabaseGrid.prototype.deleteRow = function(id)
{
   ...
   var self = this;
    ...
    if ( confirm('Are you sur you want to delete the Keyword id ' + id )  )
    {

        $.ajax({
            url: '../ajax/data_profile.php?action=delete',
            type: 'POST',
            dataType: "html",
            data: {
                id: id
...
DatabaseGrid.prototype.addRow = function(id)
{
    ...
    $.ajax({
        url: '../ajax/data_profile.php?action=insert',
        type: 'POST',
        dataType: "html",
        data: {
            ...
            StatusesCount:  $("#StatusesCount").val(),
            FollowersCount:  $("#FollowersCount").val(),
            FriendsCount:  $("#FriendsCount").val(),
            Description:  $("#Description").val(),
            TweetText:  $("#TweetText").val(),
            Sentiment:  $("#Sentiment").val(),
            Confidence:  $("#Confidence").val(),
            location:  $("#location").val(),
            TweetTimeStampStringa:  $("#TweetTimeStampStringa").val(),
            ReTweetCount:  $("#ReTweetCount").val(),
            Lingua:  $("#Lingua").val(),
            IdRicerca:  $("#IdRicerca").val()
