                ...
                <div class="row">
                    ...
                    <div class="col-md-2">  
                        ...
                        <select class="" id="cbGraphType" name="cbGraphType">
                            <option selected value="tcNetwork">Network</option>
                            <option value="tcChord">Chord</option>
                        </select>
                    </div>
                    <div class="col-md-4">  
                        &nbsp;
...
<!--    <script src="../assets/js/html2canvas.js" type="text/javascript"></script>
    <script src="../assets/js/html2canvas.svg.js" type="text/javascript"></script>-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function FocusComboEvent(str)
        {
            ...
            {
                CotrinoChartType = "chord";
                restart();
            } else if (str === 'tcNetwork')
            {
                CotrinoChartType = "network";
                restart();
            }
        }
