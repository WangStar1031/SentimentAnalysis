                ...
                <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <a id="showaddformbutton" data-toggle="modal" href="#addform" class="btn btn-default btn-xs"><i class="fa fa-plus"></i> Add new</a>
                            </div>
                        </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills" role="tablist">
                        <li role="presentation" class="active"><a href="#" style="cursor: text;">Home <span class="badge">1242</span></a></li>
...
Gestione dei twitt 7.1
1. seleziono lingua
2. insieme alla grid CRUD faccio vedere una box riepilogativi con tutti i totali

Grid composta da colonne: testo, peso (+1 o -1)